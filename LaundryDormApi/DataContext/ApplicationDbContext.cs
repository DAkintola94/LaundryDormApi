...
namespace LaundryDormApi.DataContext
{
    ...
    public DbSet <MaintenanceLogModel> MauntenanceLog { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<IdentityUserRole<string>>().HasData( //Seed data for customerUser roles
            ...
            modelBuilder.Entity.<LaundryStatusState>.HasKey(x => x.LaundryStatusID); //Setting the primary key for LaundryStatusState
            modelBuilder.Entity<MachineModel>.HasKey(x => x.MachineId); //Setting the primary key for MachineModel
            modelBuilder.Entity<MaintenanceLogModel>.HasKey(x => x.MaintenanceLogId); //Setting the primary key for MaintenanceLogModel
            modelBuilder.Entity<AdviceSet>.HasKey(x => x.AdviceId); //Setting the primary key for AdviceSet
            modelBuilder.Entity<LaundrySession>.HasKey(x => x.LaundryId); //Setting


            modelBuilder.Entity<LaundryStatusState>().HasData( //seeding data, always seed when its something that should be permanent in the database/application/problem domain
        ...
        modelBuilder.Entity<MachineModel>().HasData( //seeding data, always seed when its something that should be permanent in the database/application/problem domain
